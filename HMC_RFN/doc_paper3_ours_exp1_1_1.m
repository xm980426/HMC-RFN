...
% Process in serail between different Monte Carlo experiments,record CPU Time (exp1_1_1)
close all; clear;
...
%%
Mat = Indic;
save(['doc_paper3_ours_exp1_1_1_', cell2mat(PRItype_set(PRItype)), '-', num2str(Sp_setting), '-', num2str(Pm_setting), '-', num2str(PRIJitter), '-', num2str(Alpha), '.mat'], 'Mat');
