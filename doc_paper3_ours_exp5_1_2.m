...
PRIJitter = 0.02;                                    % PRI jitter rate - target source parameter
...
PRItype = 4;                                          % PRI modulation information - target source parameter
%------------------------------------------------------------------ Performance Metrics
...
%%
Mat = Indic;
save(['doc_paper3_ours_exp5_1_2_',cell2mat(PRItype_set(PRItype)), num2str(Yes_label), '-', num2str(Sp_setting), '-', num2str(Pm_setting), '-', num2str(PRIJitter), '-', num2str(Alpha), '.mat'], 'Mat');
