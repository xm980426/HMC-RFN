...
% Set PRI jitter rate to 0.5%, spurious pulse ratio to 50% (exp1) - 
% Set the pulse loss rate of the target source as an environmental variable (exp1_1) - 
% Process in parallel between different Monte Carlo experiments (exp1_1_2)
...
Pm0 = 0.05;                                           % Pulse loss rate - target source parameter
...
%%
Mat = Indic;
save(['doc_paper3_ours_exp1_1_2_', cell2mat(PRItype_set(PRItype)), '-', num2str(Sp_setting), '-', num2str(Pm_setting), '-', num2str(PRIJitter), '-', num2str(Alpha), '.mat'], 'Mat');
